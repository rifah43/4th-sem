...
Rconstant = (0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36)
...
def main():
    ...
    for i in range(len(exMessageText)):
        exMessage.extend([dictionary.get(ord(exMessageText[i]))]*1)

    for i in range(len(key)):
        inKey.extend([dictionary.get(ord(key[i]))]*1)
